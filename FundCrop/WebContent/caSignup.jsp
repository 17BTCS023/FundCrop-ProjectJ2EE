...
<html lang="en">
<head>
    <link rel="stylesheet" href="../CSS/casignup.css">
    <meta charset="UTF-8">
...
<!-- Outer register box, will contain all the text boxes -->
        ...
        <div class="register-box"> 
            ...
            <div class="user-login">
               ...
               <p>Sign Up as Certification Authority</p>
            <form action="ServletCaSignup" name = "signup" onsubmit="return validation()" method="post">
                <div class="textbox">
                    <p >Name:<input type="text" name="name" value="" placeholder="Akhil/ Sam.."></p>
                ...
                <div class="textbox">
                        <p >Phone:<input type="text" name="phone" value="" placeholder="000-000-0000"></p>
                </div>
