...
<body>
    ...
    <form class="w3-container" action="RequestViewed.jsp">
    ...
    <div class="row"  style="max-width:800px">
        <div class="col-12">
            ...
            <div class="w3-container w3-border-top w3-padding-16 w3-light-grey">
               <a href="farmerDashboard.jsp"<button type ="submit" onclick="farmerDashboard.jsp" type="button" class="w3-button w3-green" type="button" class="w3-button w3-" style="width: 90%">Approved </button>/>
