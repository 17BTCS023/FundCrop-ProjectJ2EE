...
System.out.print("You were redirected to The Dashboard");
String url= "jdbc:mysql://localhost:3306/fundy";
String user = "root";
String pass = "root";
int id = 3000 ; //(int) request.getAttribute("fid");
System.out.println("Id is captured"+ id);
String qry = "SELECT * from request where fid="+id+"";
...
<!-- Content of each grid -->
        ...
        <div class="card">
            <table >
                ...
                <form action="FarmerRequestStatus">
               ...
               <div class="btn">
                			<a href="viewRequest.jsp"><button onclick="document.getElementById('id01').style.display='block'" class="view1">Status</button></a>
    ...
    <div class="w3-modal-content w3-card-4 w3-animate-zoom" style="max-width:600px; text-align: center;align-content: center;">
      ...
      <form class="w3-container" action="ServletFarmerWallet" style="align-content: center;">
        <div class="w3-section" >
          ...
          <button class="w3-button w3-red w3-section w3-padding" type="submit" style="width: 40%; left: 20%; ">Withdraw Money</button>
