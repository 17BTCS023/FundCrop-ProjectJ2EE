                ...
                <ul class="user-profile">
                    <li class="hello"><i class="fa fa-user-circle" aria-hidden="true"></i>
                        ...
                        <div class="dropdown-menup">
                            <ul class="listp">
                                <li><a href="funderDashboard.jsp">Home</a></li>
...
String user = "root";
String pass = "root";
int k = (int)session.getAttribute("fuid");
String qry = "select * from funder where fuid="+k+"";
    ...
    <div class="card-title mb-4">
        <div class="d-flex justify-content-start">
            ...
            <div class="userData ml-3">
                <h2 class="d-block" style="font-size: 1.5rem; font-weight: bold"> <%=rs.getString("name")%>'s Profile</h2>
                <h6 class="d-block"><%=rs.getString("state") %></h6>
            </div>
            <div class="ml-auto">
                <input type="button" class="btn btn-primary d-none" id="btnDiscard" value="Save Changes" onclick=""/>
            </div>
        </div>
    </div>
        ...
        <div class="col-12">
            ...
            <div class="tab-content ml-1" id="myTabContent">
                <div class="tab-pane fade show active" id="basicInfo" role="tabpanel" aria-labelledby="basicInfo-tab">
                    ...
                    <div class="row">
                        <div class="col-sm-3 col-md-2 col-5">
                            <label style="font-weight:bold;">Pin number</label>
                        </div>
                        <div class="col-md-8 col-6">
                            <%=rs.getString("pin") %>
                        </div>
...
<div class="contact" id="conlink" >
            <h3>Contact :</h3>
            <a style="text-decoration: none;">Call Farmer: <%=rs.getString("phone") %></a>
