...
<!-- ___________________________________________________________________________________________________________________________________________ -->
       ...
       <div id="id01" class="w3-modal" style="display:block;">
        ...
        <div class="w3-modal-content w3-card-4 w3-animate-zoom" style="max-width:800px">
          ...
          <div class="w3-center"><br>
            <a href="funderDashboard.jsp"<span onclick="document.getElementById('id01').style.display='none'" class="w3-button w3-xlarge w3-transparent w3-display-topright"  title="Close Modal" style="max-width:50px"> ×</span>></a>
          </div>
    
    <form class="w3-container" action="" style="visiblility:visible">
    ...
    <div class="row"  style="max-width:800px">
        <div class="col-12">
            ...
            <div class="btn">
				<a href="Invest.jsp"<button  onclick="document.getElementById('id03').style.display='block'" class="w3-button w3-green" style="width: 90%; align-content: center;">Invest</button>  ></a>	         
			</div>   
