...
<body>
            ...
            <ul class="user-profile">
                <li class="hello"><i class="fa fa-user-circle" aria-hidden="true"></i>
                    ...
                    <div class="dropdown-menu">
                        <ul class="list">
                            <div class="btn">
                				<a href="caProfile.jsp"><button  class="view">My Profile</button></a>
               				</div> 
               				<div class="btn">
                				<button  onclick="document.getElementById('id02').style.display='block'" class="view">My Wallet</button>
               				</div> 
               				<div class="btn">
                				<a href="index.jsp"><button  onclick="" class="view">Log Out</button></a>
               				</div> 
                           </ul>
                    </div>
                </li>
 ...
 <!-- Designing the main page of Certification Authority, that has farmers request
    --------------------------------------------------------------------- -->
        ...
        <div class="card">
            <table >
                ...
                <tr class="start-date">
                  ...
                  <form action="ServletCaViewRequest">
...
<!-- _____________________________________________________________________________________________________________________________ -->
  ...
  <div id="id02" class="w3-modal">
    <div class="w3-modal-content w3-card-4 w3-animate-zoom" style="max-width:600px; text-align: center;align-content: center;">
      ...
      <form class="w3-container" action="/action_page.php" style="align-content: center;">
        <div class="w3-section" >
          <h3><img src="image/iconfinder_cash-money-wallet_532652.png" style="width: 50px">Total Balance<h4>Rs. | 00</h4></h3>
          <hr style="border-top: 1px solid grey">
          <label style="left: 1%;">Enter the amount</label> <input class="w3-input w3-border" type="number" style="align-content: center;width:50%; margin-left: 25%;" placeholder="Amount" name="psw" required >
   ...
   <!-- View of the request -->
       ...
       <div id="id01" class="w3-modal">
        <div class="w3-modal-content w3-card-4 w3-animate-zoom" style="max-width:800px">
          ...
          <div class="w3-center"><br>
            <span onclick="document.getElementById('id01').style.display='none'" class="w3-button w3-xlarge w3-transparent w3-display-topright"  title="Close Modal" style="max-width:50px"> ×</span>
          <!--   <img src="sprout(1).jpg" alt="Avatar" style="width:30%" class="w3-circle w3-margin-top"> -->
          </div>
    ...
    <div class="row"  style="max-width:800px">
        <div class="col-12">
           ...
           <a 	 <button onclick="document.getElementById('id01').style.display='none' "type="button" class="w3-button w3-red" type="button" class="w3-button w3-green">Reject</button> ></a>
           <a    <button onclick="document.getElementById('id01').style.display='none' "type="button" class="w3-button w3-green" type="button" class="w3-button w3-teal">Approve</button>></a>
